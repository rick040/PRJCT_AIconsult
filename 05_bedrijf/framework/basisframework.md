...
Live bijgehouden in `05_bedrijf/framework/open-beslissingen.md`, niet hier. Vier van de negen beslissingen uit dit hoofdstuk zijn op 2026-08-26 al doorgehakt (merknaam, eerste branche, productnaam, criterium casusklanten). Raadpleeg dat bestand voor de actuele status, niet deze lijst.
