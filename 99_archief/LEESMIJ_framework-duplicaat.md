...
**Opgelost:** de v1.2-inhoud staat nu in `05_bedrijf/framework/basisframework.md`. Dat is vanaf nu de enige plek. Deze kopie is hierheen verplaatst en wordt niet meer bijgewerkt.

Conform de regel in `CLAUDE.md`: verouderd materiaal gaat naar `99_archief/`, wordt niet verwijderd.
