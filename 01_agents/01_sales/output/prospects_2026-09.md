...
2. Score met de scorekaart, verdeeld over A, B en C
3. Persona bepaald per gekwalificeerd bedrijf
4. Haak gezocht. Bedrijven zonder specifieke haak blijven op "wachtend", ze gaan niet generiek de sequentie in
5. Geen prijzen in eerste contact, geen massamail
...
Opvolging per bedrijf staat in `pijplijn.md`, niet hier. De kolom "volgende actie" daar is nooit leeg.
